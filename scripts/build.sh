...
echo "  - Trainer:   $BUILD_DIR/cyberhex_ml"
echo "  - Benchmark: $BUILD_DIR/cyberhex_bench"
echo "  - Tests:     $BUILD_DIR/unit_tests"
echo "  - Examples:  $BUILD_DIR/app"
echo ""
echo "Run trainer:   CYBERHEX_CONFIG='{\"epochs\":5}' $BUILD_DIR/cyberhex_ml"
echo "Run examples:  $BUILD_DIR/app"
echo "Run tests:     $BUILD_DIR/unit_tests"
echo "Graph tests:   $BUILD_DIR/unit_tests '[graph]'"