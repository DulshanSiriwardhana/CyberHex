...
function FeatureCard({
  ...
  return (
    ...
    >
      <Card className="group h-full border-neutral-800/50 bg-neutral-900/40 hover:border-cyan-500/20 hover:shadow-[0_0_30px_rgba(6,182,212,0.08)]">
        <CardContent className="p-6 pt-6">
          <div
            className={`inline-flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br ${gradient} border border-cyan-500/10 text-2xl mb-4 group-hover:scale-110 transition-transform duration-300`}
          >
            {icon}
          </div>
        ...
        <Grid cols={4} gap="lg">
          ...
          <Stack gap="sm">
            <Link to="/" className="flex items-center gap-2">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-cyan-700 shadow-[0_0_12px_rgba(6,182,212,0.4)]">
