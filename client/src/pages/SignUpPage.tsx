...
const steps = [
  { label: "Profile", fields: ["fullname", "username"] },
        ...
        <div className="bg-[#141414] border border-[rgba(255,255,255,0.07)] rounded-2xl p-8">
          {step === 4 ? (
            ...
            <div className="text-center py-8 space-y-3">
              ...
              <h2 className="text-2xl font-spectral font-extrabold text-white">Account created!</h2>
              <p className="text-neutral-400 text-sm">Welcome to CyberHex, {fullname}!</p>
